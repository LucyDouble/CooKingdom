...
MEALKIT_CODE NUMBER(7) CONSTRAINT MEALKIT_MEALKIT_CODE_PK PRIMARY KEY, 
RECIPE_CODE NUMBER(7) CONSTRAINT MEALKIT_RECIPE_CODE_FK REFERENCES RECIPE NOT NULL,
MEALKIT_NAME VARCHAR2(30) NOT NULL,
PRICE NUMBER(7)
);
...
CART_NO VARCHAR2(20) CONSTRAINT CART_INFO_CART_NO_FK REFERENCES CART,
   MEALKIT_CODE NUMBER(7) CONSTRAINT CART_INFO_MEALKIT_CODE_FK REFERENCES MEALKIT,
...
MEALKIT_CODE NUMBER(7) CONSTRAINT ORDER_INFO_MEALKIT_CODE_FK REFERENCES MEALKIT NOT NULL,
MEALKIT_QTY NUMBER(3)
);
