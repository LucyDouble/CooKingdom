...
SHIP_CODE VARCHAR(20) NOT NULL CONSTRAINT ORDER_SHIP_CODE_FK REFERENCES SHIP,
...
SHIP_CODE VARCHAR(20) NOT NULL CONSTRAINT ORDER_INFO_SHIP_CODE_FK REFERENCES ORDERS,
...
CREATE TABLE SHIP (
    SHIP_CODE VARCHAR2(20) CONSTRAINT SHIP_SHIP_CODE_PK PRIMARY KEY,
    NAME VARCHAR2(20) NOT NULL,
    PHONE NUMBER(30) NOT NULL,
    ADDRESS VARCHAR2(300)
);
...
--������ ��������� INSERT
INSERT INTO USERS VALUES('kimttobi@ttobi.com', '김또비', '또또비', '2019-03-01',  '1234ttobi', 01012345678, '대충서울');
COMMIT;
DESC USERS;